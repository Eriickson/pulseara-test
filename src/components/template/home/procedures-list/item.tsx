...
export const ProceduresListItem: React.FC<IProceduresListItemProps> = ({ procedure }) => {
  return (
    <List.Item>
      <Box borderRadius="10px" backgroundColor="white" py="16px" pl="34px" pr="94px" w="max-content">
        <HStack spaceX="78px">
          <ProceduresListItemSection mode="text" label="Procedimiento" value={procedure.procedure} />
